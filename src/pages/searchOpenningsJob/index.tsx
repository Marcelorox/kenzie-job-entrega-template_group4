...
import { StyleBody, StyledButton, StyledMain } from "./style.ts";
...
import { IUsers } from "../../components/openingJobs/openingJobsCard/index.tsx";
...
export const SearchJobOpennings = () => {
  const { jobs,isOpen } = useContext(UserContext);
